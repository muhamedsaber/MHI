...
class _PatientApiService implements PatientApiService {
  ...
  Future<UpdateProfileResponseBody> updatePatientProfile(
    ...
    final value = UpdateProfileResponseBody.fromJson(_result.data!);
    return value;
  }

  @override
  Future<UpdatedPatientProfileModel> getUpdatedProfile(
      {required String id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<UpdatedPatientProfileModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = UpdatedPatientProfileModel.fromJson(_result.data!);
    return value;
  }
