...
class DoctorSurgeriesAppBar extends StatelessWidget {
  const DoctorSurgeriesAppBar({super.key});

  @override
  Widget build(BuildContext context) {
    return  MainAppBar(gradient: AppThemeing.doctorGradient,
          widget: Container(
